...
# os.chdir(sys._MEIPASS)   # if uncomment this than there will be some error
...
class App(QMainWindow):
    ...
    def select_file(self):
        ...
        fileName, _ = QFileDialog.getOpenFileName(
            self, "QFileDialog.getOpenFileName()", "", "All Files (*);; JPEG (*.jpeg)")
        if fileName:
            print(fileName, _)
    ...
    def resize_pic(self):
        ...
        new_pic_name, okPressed = QInputDialog.getText(
            self, "Save Image as", "Image Name:", QLineEdit.Normal, "")
        ...
        for file in files:
            ...
            if file[-4:] == '.jpg' or file[-4:] == '.png' or file[-5:] == '.jpeg' or file[-4:] == '.JPG' or file[-5:] == '.PNG' or file[-5:] == '.JPEG':
                ...
                print("Message: Compressed " +
                      str(int(images_done/total_images*100)) + "%")
                self.statusBar().showMessage("Message: Compressed " +
                                             str(int(images_done/total_images*100)) + "%")
